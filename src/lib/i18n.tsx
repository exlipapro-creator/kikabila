...
const dict = {
  sw: {
    ...
    "play.howDoYouSayPhrase": "Tafsiri sentensi hii",
    "play.translateSentence": "Tafsiri sentensi hii kwa lugha yako",
    "play.translateProverb": "Tafsiri methali hii kwa lugha yako",
    ...
    "board.tier": "Kiwango chako",
    "board.tierBronze": "Shaba",
    "board.tierSilver": "Fedha",
    "board.tierGold": "Dhahabu",
    "board.tierLegend": "Hadithi",
    "board.xpToPromote": "XP kufikia ngazi inayofuata",
    "board.weekResets": "Wiki inaisha",
    "board.promoted": "Umepanda ngazi!",
    "board.podiumTitle": "Mabingwa wa wiki iliyopita",
    "streak.title": "Mfululizo wako",
    "streak.current": "Siku mfululizo",
    "streak.longest": "Mfululizo mrefu zaidi",
    "streak.freezes": "Vinga vya mfululizo",
    "streak.freezeHint": "Kinga inakuokoa unapokosa siku moja.",
    "streak.calendar": "Kalenda ya siku 30",
    "streak.played": "Ulicheza",
    "streak.missed": "Hukucheza",
    "streak.frozen": "Kinga ilitumika",
    "streak.signIn": "Ingia ili kuona mfululizo wako.",
    "nav.profile": "Wasifu",
    ...
    "rewards.body": "Changia maneno yaliyothibitishwa, pata vocha ya simu halisi.",
    "rewards.signIn": "Ingia ili kuona zawadi zako.",
    "rewards.verified": "Yaliyothibitishwa",
    "rewards.claimed": "Zilizodaiwa",
    "rewards.toNext": "Hadi ijayo",
    "rewards.wordsLeft": "maneno zaidi",
    "rewards.readyToClaim": "Tayari kudai zawadi!",
    "rewards.airtime": "Airtime",
    "rewards.claimReward": "Dai zawadi yako",
    "rewards.claiming": "Inachukua...",
    "rewards.codeCopied": "Kodi imenakiliwa",
    "rewards.alreadyClaimed": "Umekwisha dai zawadi hii",
    "rewards.noVouchers": "Hakuna vocha zinazopatikana sasa hivi — jaribu tena baadaye",
    "rewards.notEnough": "Bado huna maneno ya kutosha yaliyothibitishwa",
    "rewards.success": "Zawadi imefanikiwa! Gusa kadi kufunua kodi yako.",
    "rewards.allClaimed": "Umepata zawadi zote!",
    "rewards.allClaimedBody": "Hongera! Endelea kuchangia — zawadi zaidi zinakuja.",
  },
  en: {
    "nav.play": "Play",
    "nav.streak": "Streak",
    ...
    "play.howDoYouSayPhrase": "Translate this phrase",
    "play.translateSentence": "Translate this sentence into your language",
    "play.translateProverb": "Translate this proverb into your language",
    ...
    "board.tier": "Your tier",
    "board.tierBronze": "Bronze",
    "board.tierSilver": "Silver",
    "board.tierGold": "Gold",
    "board.tierLegend": "Legend",
    "board.xpToPromote": "XP to next tier",
    "board.weekResets": "Week resets",
    "board.promoted": "Tier up!",
    "board.podiumTitle": "Last week's champions",
    "streak.title": "Your streak",
    "streak.current": "Day streak",
    "streak.longest": "Longest streak",
    "streak.freezes": "Streak freezes",
    "streak.freezeHint": "A freeze saves your streak when you miss a day.",
    "streak.calendar": "Last 30 days",
    "streak.played": "Played",
    "streak.missed": "Missed",
    "streak.frozen": "Freeze used",
    "streak.signIn": "Sign in to see your streak.",
    ...
    "rewards.body": "Contribute verified words, earn real airtime vouchers.",
    "rewards.signIn": "Sign in to see your rewards.",
    "rewards.verified": "Verified",
    "rewards.claimed": "Claimed",
    "rewards.toNext": "To next",
    "rewards.wordsLeft": "words to go",
    "rewards.readyToClaim": "Ready to claim!",
    "rewards.airtime": "Airtime",
    "rewards.claimReward": "Claim your reward",
    "rewards.claiming": "Claiming...",
    "rewards.codeCopied": "Code copied",
    "rewards.alreadyClaimed": "You've already claimed this reward",
    "rewards.noVouchers": "No vouchers available right now — check back soon",
    "rewards.notEnough": "You don't have enough verified words yet",
    "rewards.success": "Reward claimed! Tap the card to reveal your code.",
    "rewards.allClaimed": "You've claimed all rewards!",
    "rewards.allClaimedBody": "Amazing work. Keep contributing — more rewards are coming.",
  },
} as const;
